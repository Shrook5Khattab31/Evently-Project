...
class AppStyles{
  ///--- White TextStyle (regular) ---///
  static TextStyle regular20white= GoogleFonts.inter(
    color: AppColors.whiteColor,
    fontWeight: FontWeight.w400,
    fontSize: 20,
  );
  ///--- OffWhite TextStyle (regular) ---///
  static TextStyle regular14offWhite= GoogleFonts.inter(
  ...
  static TextStyle bold14offWhite= GoogleFonts.inter(
    color: AppColors.offWhiteColor,
    fontWeight: FontWeight.bold,
    fontSize: 14,
  );
  ...
  ///--- darkPrimary TextStyle (bold) ---///
  static TextStyle bold14darkPrimary= GoogleFonts.inter(
    color: AppColors.darkPrimaryColor,
    fontWeight: FontWeight.bold,
    fontSize: 14,
  );
  static TextStyle bold16darkPrimary= GoogleFonts.inter(
    color: AppColors.darkPrimaryColor,
    fontWeight: FontWeight.bold,
    fontSize: 16,
  );
